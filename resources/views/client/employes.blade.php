            ...
            <table class="table datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ 'img-profile/'.$employe->photo }}" width="40px" height="40px" alt="{{ 'img-profile/'.$employe->photo }}"></td>
                        <td>{{ $employe->type }}</td>
                        <td class="fix_width">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="inputText" class="col-sm-2 col-form-label">Nom utilisateur</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="username" value="{{ $employe->username }}">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="inputText" class="col-sm-2 col-form-label">Email</label>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="type" class="form-control">
                                                            <option value="gerant" {{ $employe->type === 'gerant' ? 'selected' : '' }}>Gerant</option>
                                                            <option value="superviseur" {{ $employe->type === 'superviseur' ? 'selected' : '' }}>Superviseur</option>
                                                            <option value="employe" {{ $employe->type === 'employe' ? 'selected' : '' }}>Employe</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    <label for="inputText" class="col-sm-2 col-form-label">Societe</label>
                                                    <div class="col-sm-10">
                                                        <select name="id_societe" value="{{ $employe->societe->name }}" class="form-control">
                                                            <option value="{{ $employe->societe->id }}">{{ $employe->societe->name }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#verticalycentered_{{ $employe->id }}">
                                Supprimer
                            </button>
                        </td>
                    </tr>
