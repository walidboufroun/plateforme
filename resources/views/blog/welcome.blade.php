...
<body>
              ...
              <div class="row">
                <div class="col-md-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Notre startup est dédiée à révolutionner la gestion des déchets en utilisant l'IA et l'IoT, créant
                      ainsi un avenir plus vert et plus propre.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Read More
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="{{ asset('images/gnov5.png') }}" alt="" style=" width: 100%; margin: 0px 2vw 8.8vw 0">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item ">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="{{ asset('images/removedbk_poubelle.png') }}" alt=""
                      style="width: 90%; margin-left: 2vw;">
          ...
          <!-- <div class="carousel-item">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="{{ asset('images/Green-Environment.png') }}" alt="" style="width: 50%; margin-left: 11vw;">
                  </div>
                </div>
              </div>
            </div>
  ...
  <div>
    <img src="{{ asset('images/sepa1.png') }}" alt="" style="width: 100%;">
  </div>
          ...
          <div class="col-md-4">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Nos poubelles intelligentes ont la capacité de trier, compacter automatiquement les déchets et de
                  collecter les données en temps. Ce niveau d'automatisation peut améliorer considérablement
                  l'efficience et l'efficacité des pratiques de gestion des déchets.
                </p>
                <!-- <a href="">
                  Read More
                </a> -->
          ...
          <div class="col-md-4">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  La numérisation fait référence au processus de collecte, de stockage et d’analyse des données liées à
                  la gestion des déchets dans un format numérique
                </p>
                <!-- <a href="">
                  Read More
                </a> -->
          ...
          <div class="col-md-4 ">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  En réduisant la pollution environnementale et en favorisant une utilisation plus efficace des
                  ressources, nous travaillons ensemble pour créer un avenir plus durable et plus propre. </p>
                <!-- <a href="">
                  Read More
                </a> -->
              </div>
  ...
  <!-- end product section -->
  <div>
    <img src="{{ asset('images/sepa2.png') }}" alt="" style="width: 100%;">
  </div>
  <!-- about section -->
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="{{ asset('images/gnovlogo.jpg') }}" alt="" width="62%">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
      ...
      <div class="why_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Notre système utilise une technologie de pointe pour recueillir des données en temps réel à partir de
              capteurs connectés,
              fournissant des informations cruciales sur les niveaux et les types de déchets, entre autres. Ces
              informations permettent de prendre des décisions éclairées et d'optimiser les processus de collecte et de
              tri des déchets, contribuant ainsi à un environnement plus propre et plus durable.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              La gestion des déchets est un investissement important pour la durabilité de l'environnement et la santé
              publique.
              Notre approche assure la sécurité de votre investissement en maximisant l'efficacité de la collecte, du
              tri et de la valorisation des déchets. Vous pouvez être assuré que votre contribution fait une réelle
              différence.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              ...
              Notre système de collecte de données en temps réel, associé à des capteurs connectés, permet une gestion
              efficace.
        ...
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              ...
              Nous travaillons en étroite collaboration avec des particuliers, des entreprises, des collectivités
              locales et d'autres parties prenantes pour répondre à leurs besoins spécifiques en matière de gestion des
              déchets.
      ...
      <div class="team_container">
        <div class="row">
          ...
          <!-- <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="{{ asset('images/team4.png') }}" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Zeggane Celia
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="{{ asset('images/team1.png') }}" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="{{ asset('images/team3.jpg') }}" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
                  <div class="client_info">
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="{{ asset('images/team2.jpg') }}" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
                  <div class="client_info">
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="{{ asset('images/team4.png') }}" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
                  <div class="client_info">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3 info_col">
          <div class="info_detail">
            ...
            <p>
              Notre vision est de vous offrir une solution pratique qui simplifie la gestion de vos déchets tout en
              stimulant votre entreprise. </p>
          </div>
        </div>
