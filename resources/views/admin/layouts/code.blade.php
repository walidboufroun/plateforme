...
<head>
    ...
    <title>GNOV-@yield('title')</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="assets/img/gnov.png" rel="icon">
    <link href="assets/img/gnov.png" rel="apple-touch-icon">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('Admin-Dashboard') }}" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">GNOV - STARUP </span>
            </a>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <!--<li class="nav-item">
                ...
                <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="#">
                            <i class="bi bi-circle"></i><span>Sous Page</span>
                        </a>
                    </li>
                </ul>
            </li> End Icons Nav -->
            <li class="nav-item">
                <a class="nav-link @if (trim($__env->yieldContent('title')) != 'Produit') collapsed @endif" href="{{ route('Admin-Commandes') }}">
                    <i class="bi bi-person"></i>
                    <span>Commandes</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (trim($__env->yieldContent('title')) != 'Produit') collapsed @endif" href="{{ route('Admin-Clients') }}">
                    <i class="bi bi-person"></i>
                    <span>Clients</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (trim($__env->yieldContent('title')) != 'Produit') collapsed @endif" href="{{ route('Admin-Forfaits') }}">
                    <i class="bi bi-person"></i>
                    <span>Forfaits</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (trim($__env->yieldContent('title')) != 'Produit') collapsed @endif" href="{{ route('Admin-maintenance') }}">
                    <i class="bi bi-person"></i>
